...
public final class NSALoginController {
	...
	*/
	public static void hashUserPassword(User user) throws WeakPasswordException {
		...
		if (password.length < 8 || user.getPassword().matches("[0-9]+")) {
		    WeakPasswordException w = new WeakPasswordException("Password is too weak. Passwords must be at least 8 characters long and contain at least one digit.");
		    throw w;
        }
